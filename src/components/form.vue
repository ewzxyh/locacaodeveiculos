<template>
  <form @submit.prevent="handleSubmit" class="container">
    <div class="container__row">
      <div class="row__LGPD">
        <h1 class="LGPD__title">
          Olá <br />
          Para começar, preencha seus dados básicos :
        </h1>
        <p class="LGPD__paragraph">
          Todos os seus Dados são protegidos, conforme a LGPD.
          <a
    ...
    <div class="container__row">
      <div class="row__data">
        ...
        <select
          ...
          class="data__nationality-select"
          required
        >
          ...
          <div class="mid-section__warning">
            ...
            <div class="warning__paragraph">
              ...
              <p class="paragraph__text">
                <strong>Atenção!</strong> <br />Lembre-se de revisar os dados
                preenchidos, serão importantes para concluir o seu cadastro e
                realizar a sua reserva.
              </p>
            </div>
          </div>
              ...
              <div class="row__input">
                <div class="data__email">
                  <input
                    ...
                    placeholder="Digite o seu melhor numero"
                    class="data-input"
                    required
                  />
    ...
    <div class="container__row">
      <div class="row__warning">
        ...
        <p class="warning__text">
          As informações coletadas no cadastro do cliente serão utilizadas para
          identificação das reservas e execução de contrato entre o titular e a
          NeoNavigation. Para mais informações sobre o tratamento de dados
          pessoais, acesse nosso Portal de Privacidade.
        </p>
      </div>
