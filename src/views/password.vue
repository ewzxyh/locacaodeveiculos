<template>
    <form @submit.prevent="passwordVerification" class="container">
        ...
        <div class="container__password">
            ...
            <div class="password__wraper">
                ...
                <div class="wraper__input">
                    <div class="input__border">
                        <input v-model="password" :type="passwordFieldType" class="input__password" placeholder="Digite sua senha">
                        <img @click="togllePasswordVisibility" class="border__image" :src="eyeSwapper" alt="imagem de olho">
                    </div>
                    <div class="input__border">
                        <input v-model="passwordConfirmation" :type="passwordFieldType" class="input__password"
            ...
            <p class="password__paragraph">Mínimo 6 caracteres. <br>
                Utilize pelo menos: 1 caractere especial, 1 letra maiúscula, 1 minúscula e 1 número.</p>
        </div>
    </form>
</template>
<script>
    ...
    data() {
        ...
        passwordVerification() {
            ...
            if (password === passwordConfirmation && password.length >= 6) {
                ...
                console.log('As senhas não conferem ou não contem 6 carecteres')
            }
        },
